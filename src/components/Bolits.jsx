  ...
  const descriptionBolit = [
    {
      ...
      description:
        "Делаем мебель на основе ваших предпочтений и желаний. Получаете именно то, что хотите.",
    },
    {
      img: bolFinger,
      title: "Делаем уникальную мебель",
      description:
        "Мебель сделанная специально для вас, будет подчеркивать вашу индивидуальность и стиль.",
    },
    {
      img: bolMedal,
      title: "Обеспечиваем премиум качество",
      description:
        "Благодаря 25 летнему опыту работы с мебелью учитываем все детали. Заказываем лучшие материалы по всеми миру.",
    },
  ];
    ...
    <div className="bolits">
      <div className="container">
        <div className="bolits__wrapper">
            ...
            <Slide bottom>
              {descriptionBolit.map((item) => (
                <Bolit key={`${item.title}`} {...item} />
              ))}
            </Slide>
