        ...
        <div className="container">
          <div className="policy__wrapper">
            ...
            <p>
              ...
              персональных данных, предпринимаемые Молодожон Ольга Александровна
              (далее – Оператор).
            </p>
            <ol>
              <li>
            ...
            <ol>
              <li>
                4.1. Цель обработки персональных данных Пользователя — Обратный
                звонок.
              </li>
              ...
              <li>
                ...
                Оператору письмо на адрес электронной почты olga.molodozhon@bk.ru
            ...
            <ol>
              <li>
                ...
                http://spiritmebel.ru. Заполняя соответствующие формы и/или
            ...
            <ol>
              ...
              <li>
                ...
                Оператора olga.molodozhon@bk.ru с пометкой «Актуализация
                персональных данных».
              </li>
              <li>
                ...
                olga.molodozhon@bk.ru с пометкой «Отзыв согласия на обработку
                персональных данных».
              </li>
            </ol>
            ...
            <ol>
              ...
              <li>
                ...
                в сети Интернет по адресу http://spiritmebel.ru/policy.
              </li>
            </ol>
          </div>
        </div>
