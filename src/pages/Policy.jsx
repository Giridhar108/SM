        ...
        <div className="container">
          <div className="policy__wrapper">
            ...
            <p>
              ...
              персональных данных, предпринимаемые Фоменко Герман Витальевич
              (далее – Оператор).
            </p>
            <ol>
              <li>
            ...
            <ol>
              ...
              <li>
                ...
                Оператору письмо на адрес электронной почты pentagram777@mai.ru
            ...
            <ol>
              <li>
                ...
                http://soulmebel.ru. Заполняя соответствующие формы и/или
            ...
            <ol>
              ...
              <li>
                ...
                Оператора pentagram777@mai.ru с пометкой «Актуализация
                персональных данных».
              </li>
              <li>
                ...
                pentagram777@mai.ru с пометкой «Отзыв согласия на обработку
                персональных данных».
              </li>
            </ol>
            ...
            <ol>
              ...
              <li>
                ...
                в сети Интернет по адресу http://soulmebel.ru/privacy.
              </li>
            </ol>
          </div>
        </div>
